# ==============================================
# Diccionario con toda la documentación del proyecto
# ==============================================
...
""",
    ...
    "problema": """
El negocio retail no cuenta con reportes automatizados que permitan visualizar el comportamiento de ventas, identificar productos más demandados, ni analizar el rendimiento por categoría, ciudad o medio de pago. 
Esta falta de visibilidad limita la toma de decisiones estratégicas sobre inventario, promociones, segmentación de clientes y expansión comercial.
""",

    "solucion": """
Diseñar un modelo de análisis de ventas mensual que permita:
...
- Mostrar tendencia de ganancias por mes.
- Determinar el medio de pago más usado.
- Detectar la ciudad con más compras.
- Listar los clientes principales (Top clientes).
- Encontrar el producto más vendido.
- Analizar el tiempo de conversión (alta de cuenta -> primera compra).
- Calcular el LTV de clientes por ciudad.
""",

    "estructura": """
La base de datos está organizada en formato tabular (filas y columnas), con claves únicas que permiten vincular entidades. 
...
""",
     ...
     "analisis descriptivo y de negocio": """
...
nombre_usuario = input("Por favor, ingrese su nombre: ").strip().title()
print(f"\n¡Bienvenido/a, {nombre_usuario}!")
print("Este programa le permitirá consultar la documentación técnica del proyecto 'Aurelion Retail'.\n")
...
while True:
    ...
    print("3. Problema")
    print("4. Solución")
    print("5. Estructura base de datos")
    print("6. Limpieza de datos")
    print("7. Análisis descriptivo y de negocio")
    print("8. Análisis de correlación")
    print("9. Análisis de outliers")
    print("10. Diseño ML")
    print("0. Salir")
    ...
    try:
        ...
        if opcion == 0:
            print(f"\nGracias por usar el programa, {nombre_usuario}. ¡Hasta pronto!")
            break
        elif opcion == 1:
            print(documentacion["autores"])
        elif opcion == 2:
            print(documentacion["tema"])
        elif opcion == 3:
            print(documentacion["problema"])
        elif opcion == 4:
            print(documentacion["solucion"])
        elif opcion == 5:
            print(documentacion["estructura"])
        elif opcion == 6:
            print(documentacion["limpieza de datos"])
        elif opcion == 7:
            print(documentacion["analisis descriptivo y de negocio"])
        elif opcion == 8:
            print(documentacion["analisis de correlacion"])
        elif opcion == 9:
            print(documentacion["analisis de outliers"])
        elif opcion == 10:
            print(documentacion["diseño ml"])
        else:
